        ...
        d !== void 0 &&
          ...
          (R(i[o]) && R(s[o])
            ? s[o].__swiper__
              ...
              : k(i[o], s[o])
            : !R(i[o]) && R(s[o])
            ? ((i[o] = {}), s[o].__swiper__ ? (i[o] = s[o]) : k(i[o], s[o]))
            : (i[o] = s[o]));
      }
    }
  }
...
function Le(i, e) {
  ...
  return (
    !s &&
      ...
      ((s = [...e.assignedElements()].includes(i)), s || (s = Ce(i, e))),
    s
  );
}
function Y(i) {
        ...
        ((r = new ResizeObserver((f) => {
          a = n.requestAnimationFrame(() => {
            ...
            let p = u,
              v = m;
            f.forEach((E) => {
              let { contentBoxSize: h, contentRect: S, target: g } = E;
              (g && g !== e.el) ||
                ((p = S ? S.width : (h[0] || h).inlineSize),
...
function Ne() {
  ...
  const t = i.params,
    { wrapperEl: s, slidesEl: n, size: r, rtlTranslate: a, wrongRTL: o } = i,
  ...
  for (let w = 0; w < f; w += 1) {
    ...
    if (
      (c[w] && (x = c[w]),
      I && i.grid.updateSlide(w, x, c),
      !(c[w] && N(x, "display") === "none"))
    ) {
      if (t.slidesPerView === "auto") {
        A && (c[w].style[i.getDirectionLabel("width")] = "");
        ...
        if (
          ...
          b = i.isHorizontal() ? oe(x, "width") : oe(x, "height");
        else {
          const _ = e(P, "width"),
            M = e(P, "padding-left"),
            O = e(P, "padding-right"),
        ...
        (b = (r - (t.slidesPerView - 1) * g) / t.slidesPerView),
          t.roundLengths && (b = Math.floor(b)),
          c[w] && (c[w].style[i.getDirectionLabel("width")] = `${b}px`);
      c[w] && (c[w].swiperSlideSize = b),
        p.push(b),
        t.centeredSlides
          ? ((y = y + b / 2 + T / 2 + g),
            T === 0 && w !== 0 && (y = y - r / 2 - g),
  ...
  if (
    ...
    I && i.grid.updateWrapperSize(b, u),
    !t.centeredSlides)
  ) {
    const w = [];
  ...
  if (
    ...
    $(s, "--swiper-centered-offset-before", `${-u[0]}px`),
      $(
        s,
    ...
    (i.snapGrid = i.snapGrid.map((P) => P + w)),
      (i.slidesGrid = i.slidesGrid.map((P) => P + x));
  }
  if (
    (f !== l && i.emit("slidesLengthChange"),
    u.length !== h &&
      (i.params.watchOverflow && i.checkOverflow(),
      i.emit("snapGridLengthChange")),
    m.length !== S && i.emit("slidesGridLengthChange"),
  ...
  for (let d = 0; d < s.length; d += 1) {
    ...
    const f =
      ...
      u =
        ...
        (l.swiperSlideSize + o),
      m = -(a - c),
      p = m + e.slidesSizesGrid[d],
      v = m >= 0 && m <= e.size - e.slidesSizesGrid[d],
      E =
        (m >= 0 && m < e.size - 1) ||
        (p > 1 && p <= e.size) ||
        (m <= 0 && p >= e.size);
    E && (e.visibleSlides.push(l), e.visibleSlidesIndexes.push(d)),
      ae(l, E, t.slideVisibleClass),
      ae(l, v, t.slideFullyVisibleClass),
      (l.progress = n ? -f : f),
...
function je() {
  const i = this,
    ...
    o = (f) => B(s, `.${t.slideClass}${f}, swiper-slide${f}`)[0];
  let d, l, c;
  if (r)
    if (t.loop) {
      ...
      f < 0 && (f = i.virtual.slides.length + f),
        ...
        (d = o(`[data-swiper-slide-index="${f}"]`));
    } else d = o(`[data-swiper-slide-index="${n}"]`);
  else
    a
      ? ((d = e.find((f) => f.column === n)),
        (c = e.find((f) => f.column === n + 1)),
        (l = e.find((f) => f.column === n - 1)))
      : (d = e[n]);
  d &&
    (a ||
      ((c = ze(d, `.${t.slideClass}, swiper-slide`)[0]),
      t.loop && !c && (c = e[0]),
      (l = Oe(d, `.${t.slideClass}, swiper-slide`)[0]),
      t.loop && !l === 0 && (l = e[e.length - 1]))),
    e.forEach((f) => {
      U(f, f === d, t.slideActiveClass),
        U(f, f === c, t.slideNextClass),
        U(f, f === l, t.slidePrevClass);
    }),
    i.emitSlidesClasses();
}
const W = (i, e) => {
  ...
  te = (i) => {
    ...
    if (i.params.grid && i.params.grid.rows > 1) {
      const a = n,
        o = [a - e];
      o.push(...Array.from({ length: e }).map((d, l) => a + s + l)),
...
function Xe(i) {
  const e = this,
    ...
    { snapGrid: s, params: n, activeIndex: r, realIndex: a, snapIndex: o } = e;
  let d = i,
    l;
  const c = (m) => {
...
function Qe(i, e) {
  ...
  let o = 0,
    d = 0;
  const l = 0;
  t.isHorizontal() ? (o = s ? -i : i) : (d = i),
    n.roundLengths && ((o = Math.floor(o)), (d = Math.floor(d))),
    (t.previousTranslate = t.translate),
    (t.translate = t.isHorizontal() ? o : d),
    n.cssMode
      ...
      : n.virtualTranslate ||
        ...
        (r.style.transform = `translate3d(${o}px, ${d}px, ${l}px)`));
  let c;
...
function ot(i, e, t, s, n) {
  ...
  let E = v + Math.floor((a - v) / r.params.slidesPerGroup);
  E >= d.length && (E = d.length - 1);
  const h = -d[E];
  if (o.normalizeSlideIndex)
    for (let I = 0; I < l.length; I += 1) {
      const b = -Math.floor(h * 100),
        A = Math.floor(l[I] * 100),
        w = Math.floor(l[I + 1] * 100);
      typeof l[I + 1] < "u"
        ? b >= A && b < w - (w - A) / 2
          ? (a = I)
          : b >= A && b < w && (a = I + 1)
  ...
  if (
    ...
    return !1;
  a !== (c || 0) && t && r.emit("beforeSlideChangeStart"), r.updateProgress(h);
  let S;
  ...
  if (o.cssMode) {
    ...
    if (e === 0)
      ...
      if (!r.support.smoothScroll)
        return (
          me({ swiper: r, targetPosition: b, side: I ? "left" : "top" }), !0
        );
      m.scrollTo({ [I ? "left" : "top"]: b, behavior: "smooth" });
    }
    return !0;
  }
  const C = ve().isSafari;
  return (
    g && !n && C && r.isElement && r.virtual.update(!1, !1, a),
    r.setTransition(e),
    r.setTranslate(h),
    r.updateActiveIndex(a),
    r.updateSlidesClasses(),
...
function at(i, e, t, s) {
  ...
  if (n.params.loop)
    if (n.virtual && n.params.virtual.enabled) a = a + n.virtual.slidesBefore;
      ...
      let f = d - o < c;
      if (
        (l && (f = f || o < Math.ceil(c / 2)),
        s && l && n.params.slidesPerView !== "auto" && !r && (f = !1),
        f)
      ) {
        const u = l
          ? o < n.activeIndex
  ...
  if (e.loop) {
    ...
    (r = parseInt(i.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
      e.centeredSlides
        ...
        ? (i.loopFix(),
          (n = i.getSlideIndex(
            B(t, `${a}[data-swiper-slide-index="${r}"]`)[0]
          )),
          pe(() => {
            i.slideTo(n);
          }))
...
function mt(i, e) {
  ...
  const r = () => {
      B(n, `.${s.slideClass}, swiper-slide`).forEach((m, p) => {
        m.setAttribute("data-swiper-slide-index", p);
      });
    },
    a = () => {
      const u = B(n, `.${s.slideBlankClass}`);
      u.forEach((m) => {
        m.remove();
      }),
  ...
  const d = s.slidesPerGroup * (o ? s.grid.rows : 1),
    l = t.slides.length % d !== 0,
    c = o && t.slides.length % s.grid.rows !== 0,
    f = (u) => {
      for (let m = 0; m < u; m += 1) {
        const p = t.isElement
          ? ee("swiper-slide", [s.slideBlankClass])
          : ee("div", [s.slideClass, s.slideBlankClass]);
        t.slidesEl.append(p);
      }
    };
  if (l) {
    if (s.loopAddBlankSlides) {
      const u = d - (t.slides.length % d);
...
function ht(i) {
  ...
  const {
    ...
    { centeredSlides: v, initialSlide: E } = p;
  if (
    ((l.allowSlidePrev = !0),
    (l.allowSlideNext = !0),
  ...
  c.length < h + g || (l.params.effect === "cards" && c.length < h + g * 2)
    ? Y(
  ...
  const T = [],
    C = [],
    I = y ? Math.ceil(c.length / p.grid.rows) : c.length,
    b = a && I - E < h && !v;
  let A = b ? E : l.activeIndex;
  typeof r > "u"
    ? (r = l.getSlideIndex(
        c.find((M) => M.classList.contains(p.slideActiveClass))
      ))
    : (A = r);
  const w = s === "next" || !s,
    x = s === "prev" || !s;
  let P = 0,
    L = 0;
  const _ = (y ? c[r].column : r) + (v && typeof n > "u" ? -h / 2 + 0.5 : 0);
  if (_ < g) {
    P = Math.max(g - _, S);
    for (let M = 0; M < g - _; M += 1) {
      const O = M - Math.floor(M / I) * I;
      if (y) {
        const G = I - O - 1;
        for (let D = c.length - 1; D >= 0; D -= 1)
          c[D].column === G && T.push(D);
      } else T.push(I - O - 1);
    }
  } else if (_ + h > I - g) {
    (L = Math.max(_ - (I - g * 2), S)), b && (L = Math.max(L, h - I + E + 1));
    for (let M = 0; M < L; M += 1) {
      const O = M - Math.floor(M / I) * I;
      y
        ? c.forEach((G, D) => {
  ...
  if (
    ...
    p.slidesPerView === "auto"
      ? l.updateSlides()
      : y &&
        ((T.length > 0 && x) || (C.length > 0 && w)) &&
        l.slides.forEach((M, O) => {
    ...
    if (T.length > 0 && x) {
      if (typeof e > "u") {
        ...
        d
          ...
          : (l.slideTo(A + Math.ceil(P), 0, !1, !0),
            n &&
              ((l.touchEventsData.startTranslate =
                l.touchEventsData.startTranslate - G),
              (l.touchEventsData.currentTranslate =
                l.touchEventsData.currentTranslate - G)));
      } else if (n) {
        const M = y ? T.length / p.grid.rows : T.length;
      ...
      if (typeof e > "u") {
        ...
        const M = y ? C.length / p.grid.rows : C.length;
        l.slideTo(l.activeIndex - M, 0, !1, !0);
      }
  }
  if (
...
function yt(i) {
  ...
  let d = s.target;
  if (
    (r.touchEventsTarget === "wrapper" && !Le(d, e.wrapperEl)) ||
...
function bt(i) {
  ...
  if (d.type === "touchmove") {
    if (
      ((l = [...d.changedTouches].find((T) => T.identifier === s.touchId)),
  ...
  if (typeof s.isScrolling > "u") {
    ...
    (t.isVertical() && r.currentX === r.startX)
      ? (s.isScrolling = !1)
      : u * u + m * m >= 25 &&
        ((T = (Math.atan2(Math.abs(m), Math.abs(u)) * 180) / Math.PI),
  ...
  if (!s.isMoved) {
    if (
      (h && S && t.loopFix({ direction: t.swipeDirection }),
        ...
        s.currentTranslate > t.minTranslate() &&
          ...
          n.resistance &&
            (s.currentTranslate =
              t.minTranslate() -
              1 +
              (-t.minTranslate() + s.startTranslate + p) ** y)))
      : p < 0 &&
        (h &&
          S &&
          s.allowThresholdMove &&
        ...
        s.currentTranslate < t.maxTranslate() &&
          ...
          n.resistance &&
            (s.currentTranslate =
              t.maxTranslate() +
              1 -
              (t.maxTranslate() - s.startTranslate - p) ** y))),
...
function Et(i) {
  ...
  if (s.type === "touchend" || s.type === "touchcancel") {
    if (
      ((n = [...s.changedTouches].find((T) => T.identifier === t.touchId)),
  ...
  for (
    ...
    typeof l[T + C] < "u"
      ? (p || (m >= l[T] && m < l[T + C])) && ((v = T), (E = l[T + C] - l[T]))
      : (p || m >= l[T]) && ((v = T), (E = l[l.length - 1] - l[l.length - 2]));
  }
  let h = null,
    S = null;
  a.rewind &&
  ...
  if (u > a.longSwipesMs) {
    ...
    e.swipeDirection === "next" &&
      (g >= a.longSwipesRatio
        ? e.slideTo(a.rewind && e.isEnd ? h : v + y)
        : e.slideTo(v)),
    ...
    (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl)
      ? s.target === e.navigation.nextEl
        ? e.slideTo(v + y)
        : e.slideTo(v)
      : (e.swipeDirection === "next" && e.slideTo(h !== null ? h : v + y),
...
const Se = (i, e) => {
  ...
  !n ||
    typeof n == "string" ||
    (t[d]("touchstart", i.onDocumentTouchStart, { passive: !1, capture: o }),
    n[d]("touchstart", i.onTouchStart, { passive: !1 }),
    n[d]("pointerdown", i.onTouchStart, { passive: !1 }),
    t[d]("touchmove", i.onTouchMove, { passive: !1, capture: o }),
    t[d]("pointermove", i.onTouchMove, { passive: !1, capture: o }),
  ...
  u && !m
    ...
    ["navigation", "pagination", "scrollbar"].forEach((C) => {
      ...
      const I = s[C] && s[C].enabled,
        b = f[C] && f[C].enabled;
      I && !b && i[C].disable(), !I && b && i[C].enable();
    });
  const h = f.direction && f.direction !== s.direction,
    S = s.loop && (f.slidesPerView !== s.slidesPerView || h),
    g = s.loop;
  h && t && i.changeDirection(), k(i.params, f);
  ...
  slidesPerViewDynamic(e, t) {
    ...
    if (n.centeredSlides) {
      ...
      for (let m = l + 1; m < r.length; m += 1)
        r[m] &&
          !u &&
          ((f += Math.ceil(r[m].swiperSlideSize)), (c += 1), f > d && (u = !0));
      for (let m = l - 1; m >= 0; m -= 1)
        r[m] &&
          !u &&
          ((f += r[m].swiperSlideSize), (c += 1), f > d && (u = !0));
    } else if (e === "current")
      for (let f = l + 1; f < r.length; f += 1)
        (t ? a[f] + o[f] - a[l] < d : a[f] - a[l] < d) && (c += 1);
  ...
  mount(e) {
    ...
    return (
      !a &&
        ...
        ((a = ee("div", t.params.wrapperClass)),
        s.append(a),
        B(s, `.${t.params.slideClass}`).forEach((o) => {
          a.append(o);
        })),
      Object.assign(t, {
        el: s,
